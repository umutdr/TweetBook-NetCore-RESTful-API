    ...
    public class IdentityService : IIdentityService
    {
        ...
        public async Task<AuthenticationResult> RefreshTokenAsync(string jwtToken, string refreshToken)
        {
            ...
            if (storedRefreshToken.Invalidated)
                return new AuthenticationResult { Errors = new[] { "This refresh token has ben invalidated" } };

            if (storedRefreshToken.Used)
                return new AuthenticationResult { Errors = new[] { "This refresh token has ben used before" } };
        ...
        private ClaimsPrincipal GetPrincipalFromToken(string token)
        {
            ...
            try
            {
                ...
                if (!IsJwtWithSecuirtyAlgorithm(validatedToken))
                    return null;
            ...
            {
                Console.WriteLine("IdentityService.cs ClaimsPrincipal Method Has An Error");
                return null;
            }
        }

        private bool IsJwtWithSecuirtyAlgorithm(SecurityToken validatedToken)
        {
